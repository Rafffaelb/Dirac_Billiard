...
void Chiral_Unitary::Save_txt_files_Correlators_Bell_Inequality_Gamma(MatrixXd Correlator_C11, MatrixXd Correlator_C22, MatrixXd Correlator_C12, MatrixXd Correlator_C21, int num_steps){

	std::ofstream output_Correlator_C11("Data_Analysis/Bell_Parameter/Correlator_Gamma/Dirac_Correlator_C11_U_Gamma.txt");
	std::ofstream output_Correlator_C22("Data_Analysis/Bell_Parameter/Correlator_Gamma/Dirac_Correlator_C22_U_Gamma.txt");
	std::ofstream output_Correlator_C12("Data_Analysis/Bell_Parameter/Correlator_Gamma/Dirac_Correlator_C12_U_Gamma.txt");
	std::ofstream output_Correlator_C21("Data_Analysis/Bell_Parameter/Correlator_Gamma/Dirac_Correlator_C21_U_Gamma.txt");
