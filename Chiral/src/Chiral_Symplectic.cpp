...
void Chiral_Symplectic::Save_txt_files_Concurrence_Gamma(MatrixXd Concurrence, MatrixXd Entanglement, int num_steps){
	...
	std::ofstream output_Concurrence("Data_Analysis/Concurrence/Dirac_Concurrence_S_Gamma.txt");
	std::ofstream output_Entanglement("Data_Analysis/Concurrence/Dirac_Entanglement_S_Gamma.txt");
