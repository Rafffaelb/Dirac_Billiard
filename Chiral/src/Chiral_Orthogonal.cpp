...
Chiral_Orthogonal::Chiral_Orthogonal(double lambda, int spin_deg, int chiral_deg){
...
void Chiral_Orthogonal::Save_txt_files_Energy(MatrixXcd G, int num_steps, int N1){

	std::ofstream output_G("Data_Analysis/Energy/Energy_Channel/Dirac_G_O_Gamma_N"+to_string(N1)+".txt");
...
void Chiral_Orthogonal::Save_txt_files_Energy_Gamma(MatrixXcd G, int num_steps, int N1, int gamma_idx){

	std::ofstream output_G("Data_Analysis/Energy/Energy_Gamma/Dirac_G_O_Gamma_N"+to_string(N1)+"_"+to_string(gamma_idx)+".txt");
